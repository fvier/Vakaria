def store_info(request):
    """Disponibiliza os dados de contato, endereço e redes sociais da Vakaria globalmente em todos os templates."""
    return {
        "STORE_NAME": "Vakaria Barbearia",
        ...
        "STORE_INSTAGRAM_URL": "https://www.instagram.com/vakariabarbearia/",
