...
class Command(BaseCommand):
    help = "Popula o banco de dados com marcas, categorias, drops e peças de moda da Grife HF"

    def handle(self, *args, **options):
        self.stdout.write(self.style.NOTICE("🌱 Iniciando o Seed de Moda da Grife HF..."))

        # 1. Superuser
        if not User.objects.filter(email="admin@grifehf.com.br").exists():
            User.objects.create_superuser("admin@grifehf.com.br", "admin123", name="Administrador Grife HF")
            self.stdout.write(self.style.SUCCESS("✅ Superusuário criado: admin@grifehf.com.br / admin123"))
        ...
        self.stdout.write(self.style.SUCCESS("\n🎉 Seed da Grife HF concluído com sucesso total!"))
